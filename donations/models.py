...
class donation(models.Model):
    """
    Model to create donation items
    """
    donation_number = models.CharField(max_length=32, null=False,
                                       editable=False)

    donater_name = models.ForeignKey(User, on_delete=models.CASCADE,
                                     related_name="donater")

    email = models.EmailField(max_length=254, null=False, blank=False)

    donation_recipient = models.ForeignKey(Session, on_delete=models.SET_NULL,
